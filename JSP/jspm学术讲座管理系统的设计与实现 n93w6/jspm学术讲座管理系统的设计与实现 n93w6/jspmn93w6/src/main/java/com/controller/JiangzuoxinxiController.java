...
public class JiangzuoxinxiController {
    ...
    public R info(@PathVariable("id") Long id){
		...
		jiangzuoxinxi.setClicknum(jiangzuoxinxi.getClicknum()+1);
		jiangzuoxinxi.setClicktime(new Date());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<JiangzuoxinxiEntity> wrapper = new EntityWrapper<JiangzuoxinxiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = jiangzuoxinxiService.selectCount(wrapper);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,JiangzuoxinxiEntity jiangzuoxinxi, HttpServletRequest request,String pre){
        EntityWrapper<JiangzuoxinxiEntity> ew = new EntityWrapper<JiangzuoxinxiEntity>();
