...
<%
	...
	//设定允许的文件后缀名
	myUpload.setAllowedExtList("gif,jpg,doc");
	...
	try
		{
			...
			for(int i=0;i<myFiles.getCount();i++)
			{
				...
				if(myFiles.getFile(i).getExtName().equals("doc"))
					setRealPath=application.getRealPath(File.separator+"example"+File.separator+"e2_uploadFiles"+File.separator+"word");
				else if(myFiles.getFile(i).getExtName().equals("gif") || myFiles.getFile(i).getExtName().equals("jpg"))
					setRealPath=application.getRealPath(File.separator+"example"+File.separator+"e2_uploadFiles"+File.separator+"pic");
