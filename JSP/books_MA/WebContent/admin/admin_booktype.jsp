					...
					<div class="col-lg-12">
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							<div class="panel-heading">
								<div class="text-muted bootstrap-admin-box-title">论文分类管理</div>
							</div>
							<div
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="updateModalLabel">修改论文分类</h4>
					</div>
							...
							<div class="col-sm-7">
								<input type="hidden" name="tid" id="updatetid">
								 <input
									...
									placeholder="请输入论文分类名称"> <label class="control-label"
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="addBookName"
									required="required" name="typeName" placeholder="请输入论文分类名称">
