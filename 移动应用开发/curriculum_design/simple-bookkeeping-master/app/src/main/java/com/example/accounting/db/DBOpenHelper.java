...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(sql);
//        //创建支出表
//        sql = "create table accounttb1(id integer primary key autoincrement,typename varchar(10),sImageId integer,beizhu varchar(80),money float," +
//                "time varchar(60),year integer,month integer,day integer,kind integer)";
//        db.execSQL(sql);
//        //创建收入表
//        sql = "create table accounttb2(id integer primary key autoincrement,typename varchar(10),sImageId integer,beizhu varchar(80),money float," +
//                "time varchar(60),year integer,month integer,day integer,kind integer)";
//        db.execSQL(sql);
//        //创建历史记录表
//        sql = "create table accounttb3(id integer primary key autoincrement,typename varchar(10),sImageId integer,beizhu varchar(80),money float," +
//                "time varchar(60),year integer,month integer,day integer,kind integer)";
//        db.execSQL(sql);
    }
