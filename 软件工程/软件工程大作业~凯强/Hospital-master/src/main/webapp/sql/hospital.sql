...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='管理员信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb3 COMMENT='科室信息表';

-- 正在导出表  hospital.department 的数据：~7 rows (大约)
/*!40000 ALTER TABLE `department` DISABLE KEYS */;
REPLACE INTO `department` (`Department_id`, `Department_name`, `Department_Phone`) VALUES
	(1, '内科', '13663894233'),
	(2, '外科', '15288347293'),
	(3, '妇产科', '13964768919'),
	(4, '耳鼻喉科', '13698472397'),
...
REPLACE INTO `doctor` (`Doctor_id`, `Doctor_name`, `Doctor_age`, `Doctor_sex`, `Doctor_title`, `Doctor_speciality`, `Department_id`, `username`, `password`) VALUES
...
DROP TABLE IF EXISTS `doctor_state`;
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb3 COMMENT='医生挂号日期状态表';

-- 正在导出表  hospital.doctor_state 的数据：~31 rows (大约)
/*!40000 ALTER TABLE `doctor_state` DISABLE KEYS */;
REPLACE INTO `doctor_state` (`Doctor_state_id`, `Doctor_id`, `Date`, `Fee`, `Num`) VALUES
	(2, 3, '2023-06-06', 40, 7),
	(3, 4, '2023-06-06', 40, 20),
	(4, 5, '2023-06-06', 20, 20),
	(5, 6, '2023-06-06', 10, 20),
	(6, 1, '2023-06-06', 40, 0),
	(7, 2, '2023-06-06', 20, 16),
	(8, 1, '2023-06-07', 40, 20),
	(9, 2, '2023-06-07', 20, 20),
	(10, 3, '2023-06-07', 40, 20),
	(11, 4, '2023-06-07', 40, 20),
	(12, 5, '2023-06-07', 20, 20),
	(13, 6, '2023-06-07', 10, 20),
	(14, 1, '2023-06-08', 40, 30),
	(15, 2, '2023-06-08', 20, 19),
	(16, 3, '2023-06-08', 40, 20),
	(17, 4, '2023-06-08', 40, 20),
	(18, 5, '2023-06-08', 20, 20),
	(19, 6, '2023-06-08', 10, 20),
	(20, 1, '2023-06-09', 40, 19),
	(21, 2, '2023-06-09', 20, 20),
	(22, 3, '2023-06-09', 40, 19),
	(23, 4, '2023-06-09', 40, 20),
	(24, 5, '2023-06-09', 20, 20),
	(25, 6, '2023-06-09', 10, 19),
	(26, 1, '2023-06-10', 40, 19),
	(27, 2, '2023-06-10', 20, 20),
	(28, 3, '2023-06-10', 40, 20),
	(29, 4, '2023-06-10', 40, 20),
	(30, 5, '2023-06-10', 20, 19),
	(31, 6, '2023-06-10', 10, 20),
	(32, 1, '2023-06-11', 40, 18);
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COMMENT='药品信息表';

-- 正在导出表  hospital.drug 的数据：~8 rows (大约)
/*!40000 ALTER TABLE `drug` DISABLE KEYS */;
REPLACE INTO `drug` (`Drug_id`, `Drug_name`, `Drug_lotnumber`, `Drug_indication`, `Drug_price`) VALUES
...
) ENGINE=InnoDB AUTO_INCREMENT=61 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='取药信息表';

-- 正在导出表  hospital.getdrug 的数据：~3 rows (大约)
/*!40000 ALTER TABLE `getdrug` DISABLE KEYS */;
REPLACE INTO `getdrug` (`Get_id`, `Drug_id`, `Drug_num`, `Get_time`, `Treat_id`) VALUES
	(58, 1, 1, '2023-06-01 16:21:23', 22),
	(59, 1, 2, '2023-06-06 17:03:16', 29),
	(60, 2, 1, '2023-06-06 17:03:16', 29);
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb3 COMMENT='患者信息表';

-- 正在导出表  hospital.patient 的数据：~8 rows (大约)
/*!40000 ALTER TABLE `patient` DISABLE KEYS */;
REPLACE INTO `patient` (`Patient_id`, `Patient_name`, `Patient_age`, `Patient_sex`, `Patient_Address`, `Patient_Phone`, `username`, `password`) VALUES
	...
	(17, '张三', 21, '男', '萨达', '123123123123', '张三', '123'),
	(20, '王五', 28, '男', '阿士大夫撒旦法撒旦法', '12312312312', '王五', '123123');
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb3 COMMENT='挂号信息表';

-- 正在导出表  hospital.register 的数据：~8 rows (大约)
/*!40000 ALTER TABLE `register` DISABLE KEYS */;
REPLACE INTO `register` (`Register_id`, `Patient_id`, `Doctor_id`, `Register_time`, `Register_fee`, `Register_state`) VALUES
	(19, 13, 1, '2023-06-01', 40, 1),
	(20, 17, 1, '2023-06-01', 40, 1),
	(21, 17, 1, '2023-06-01', 40, 1),
	(22, 17, 1, '2023-06-01', 40, 1),
	(23, 17, 1, '2023-06-01', 40, 2),
	(25, 17, 2, '2023-06-01', 20, 0),
	(26, 15, 2, '2023-06-06', 20, 0),
	(27, 17, 2, '2023-06-06', 20, 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='看病信息表';

-- 正在导出表  hospital.treat 的数据：~8 rows (大约)
/*!40000 ALTER TABLE `treat` DISABLE KEYS */;
REPLACE INTO `treat` (`Treat_id`, `Patient_id`, `Doctor_id`, `Treat_dateTime`, `symptom`, `Diagnose_info`) VALUES
	(22, 15, 1, '2023-06-01 16:21:23', '风湿感冒', '阿斯顿发送到'),
	(23, 17, 1, '2023-06-01 16:21:23', '', ''),
	(24, 17, 1, '2023-06-01 17:46:44', '', ''),
	(25, 17, 1, '2023-06-01 17:46:52', '', ''),
	(26, 17, 1, '2023-06-01 17:46:54', '', ''),
	(27, 13, 1, '2023-06-05 18:22:53', '', ''),
	(28, 17, 1, '2023-06-05 23:00:53', '', ''),
	(29, 17, 2, '2023-06-06 17:03:16', '咳嗽', '感冒');
