...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='养修信息预约';

-- ----------------------------
-- Records of bus_appointment
-- ----------------------------
INSERT INTO `bus_appointment` VALUES ('1', '肖战', '13088889999', '2021-05-19 15:45:00', '2021-05-19 11:49:24', '豫A66688', '宝马X5', '1', '2021-05-19 11:49:17', 'hello', '5');
...
CREATE TABLE `bus_bpmn_info` (
  ...
  `bpmn_label` varchar(255) DEFAULT NULL COMMENT '流程名称-数据字典label',
  `bpmn_type` varchar(255) DEFAULT NULL COMMENT '流程类型-数据字典value',
  `process_definition_key` varchar(255) DEFAULT NULL COMMENT 'activity流程定义生成的key',
  `deploy_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '部署时间',
  `version` int(11) DEFAULT NULL COMMENT '版本号',
  `info` varchar(255) DEFAULT NULL COMMENT '描述信息',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='流程定义明细';
...
CREATE TABLE `bus_car_package_audit` (
  ...
  `service_item_name` varchar(255) DEFAULT NULL,
...
INSERT INTO `bus_service_item` VALUES ('3', '洗车套餐', '3001.00', '1800.00', '1', '无水洗车、泡沫精致洗车、全自动电脑洗车、底盘清洗', '2021-05-14 10:33:24', '1', '0', '0');
...
INSERT INTO `bus_service_item` VALUES ('8', '车饰美容', '6000.00', '1501.00', '1', '车饰美容包括仪表台、顶棚、地毯。脚垫、座椅、座套、车门内饰的吸尘清洁保护，以及蒸汽杀菌、冷暖风口除臭、室内空气净化、内饰清洁、表盘上光、包真皮、车内除味等项目。', '2021-05-27 11:21:53', '1', '0', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='结算单';

-- ----------------------------
-- Records of bus_statement
-- ----------------------------
INSERT INTO `bus_statement` VALUES ('1', '苏炳添', '13099996666', '2021-10-27 16:06:17', '粤A88888', '宝马', '0', '9', '1', '2021-10-27 16:24:10', '1', '256.00', '2.00', '0.00', '2021-10-27 16:23:57', null, '0');
INSERT INTO `bus_statement` VALUES ('2', '易建联', '13033336666', '2021-10-28 18:30:00', '粤X9999', '奔驰', '0', null, '1', '2021-10-27 17:00:50', '1', '675.00', '3.00', '20.00', null, '', '0');
...
CREATE TABLE `bus_statement_item` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='结算单明细';
...
CREATE TABLE `sys_dict_data` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='字典数据表';
...
INSERT INTO `sys_dict_data` VALUES ('41', '1', '维修', '0', 'si_service_catalog', '', 'primary', 'Y', '0', '');
INSERT INTO `sys_dict_data` VALUES ('42', '2', '保养', '1', 'si_service_catalog', '', 'success', 'N', '0', '');
INSERT INTO `sys_dict_data` VALUES ('43', '3', '其他', '2', 'si_service_catalog', '', 'warning', 'N', '0', '');
...
INSERT INTO `sys_dict_data` VALUES ('64', '6', '已支付', '5', 'cmi_status', '', '', 'N', '0', '');
...
CREATE TABLE `sys_logininfo` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=449 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfo` VALUES ('295', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 11:19:37');
INSERT INTO `sys_logininfo` VALUES ('296', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 11:26:38');
INSERT INTO `sys_logininfo` VALUES ('297', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 14:47:24');
INSERT INTO `sys_logininfo` VALUES ('298', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 14:53:33');
INSERT INTO `sys_logininfo` VALUES ('299', 'lin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2021-12-09 15:36:56');
INSERT INTO `sys_logininfo` VALUES ('300', 'lin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2021-12-09 15:37:26');
INSERT INTO `sys_logininfo` VALUES ('301', 'lin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2021-12-09 15:37:43');
INSERT INTO `sys_logininfo` VALUES ('302', 'lin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '1', '用户不存在/密码错误', '2021-12-09 15:37:53');
INSERT INTO `sys_logininfo` VALUES ('303', 'yf', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 15:38:32');
INSERT INTO `sys_logininfo` VALUES ('304', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 15:38:37');
INSERT INTO `sys_logininfo` VALUES ('305', 'yf', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 15:39:08');
INSERT INTO `sys_logininfo` VALUES ('306', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 15:39:21');
INSERT INTO `sys_logininfo` VALUES ('307', 'yf', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 15:39:50');
INSERT INTO `sys_logininfo` VALUES ('308', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 15:49:26');
INSERT INTO `sys_logininfo` VALUES ('309', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 16:01:16');
INSERT INTO `sys_logininfo` VALUES ('310', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 16:27:39');
INSERT INTO `sys_logininfo` VALUES ('311', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 16:28:28');
INSERT INTO `sys_logininfo` VALUES ('312', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 16:31:54');
INSERT INTO `sys_logininfo` VALUES ('313', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 19:18:14');
INSERT INTO `sys_logininfo` VALUES ('314', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-09 19:19:06');
INSERT INTO `sys_logininfo` VALUES ('315', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 09:29:09');
INSERT INTO `sys_logininfo` VALUES ('316', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 10:38:10');
INSERT INTO `sys_logininfo` VALUES ('317', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 10:39:12');
INSERT INTO `sys_logininfo` VALUES ('318', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 10:40:24');
INSERT INTO `sys_logininfo` VALUES ('319', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 11:01:02');
INSERT INTO `sys_logininfo` VALUES ('320', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 12:56:45');
INSERT INTO `sys_logininfo` VALUES ('321', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 14:24:29');
INSERT INTO `sys_logininfo` VALUES ('322', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 14:31:17');
INSERT INTO `sys_logininfo` VALUES ('323', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 14:49:06');
INSERT INTO `sys_logininfo` VALUES ('324', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 14:58:26');
INSERT INTO `sys_logininfo` VALUES ('325', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 15:08:52');
INSERT INTO `sys_logininfo` VALUES ('326', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 15:11:13');
INSERT INTO `sys_logininfo` VALUES ('327', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 15:20:44');
INSERT INTO `sys_logininfo` VALUES ('328', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 15:42:30');
INSERT INTO `sys_logininfo` VALUES ('329', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 16:20:13');
INSERT INTO `sys_logininfo` VALUES ('330', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 16:27:30');
INSERT INTO `sys_logininfo` VALUES ('331', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 17:03:05');
INSERT INTO `sys_logininfo` VALUES ('332', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 17:24:56');
INSERT INTO `sys_logininfo` VALUES ('333', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 17:26:23');
INSERT INTO `sys_logininfo` VALUES ('334', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 17:26:26');
INSERT INTO `sys_logininfo` VALUES ('335', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 19:46:22');
INSERT INTO `sys_logininfo` VALUES ('336', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-10 19:58:24');
INSERT INTO `sys_logininfo` VALUES ('337', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 09:55:57');
INSERT INTO `sys_logininfo` VALUES ('338', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 10:14:54');
INSERT INTO `sys_logininfo` VALUES ('339', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 10:22:52');
INSERT INTO `sys_logininfo` VALUES ('340', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 10:25:17');
INSERT INTO `sys_logininfo` VALUES ('341', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 10:58:32');
INSERT INTO `sys_logininfo` VALUES ('342', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 11:00:39');
INSERT INTO `sys_logininfo` VALUES ('343', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 11:17:23');
INSERT INTO `sys_logininfo` VALUES ('344', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 11:27:31');
INSERT INTO `sys_logininfo` VALUES ('345', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 11:43:39');
INSERT INTO `sys_logininfo` VALUES ('346', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 11:47:08');
INSERT INTO `sys_logininfo` VALUES ('347', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 15:29:06');
INSERT INTO `sys_logininfo` VALUES ('348', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 15:41:37');
INSERT INTO `sys_logininfo` VALUES ('349', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 15:43:21');
INSERT INTO `sys_logininfo` VALUES ('350', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 15:44:57');
INSERT INTO `sys_logininfo` VALUES ('351', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 15:50:13');
INSERT INTO `sys_logininfo` VALUES ('352', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 15:51:09');
INSERT INTO `sys_logininfo` VALUES ('353', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 16:12:41');
INSERT INTO `sys_logininfo` VALUES ('354', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 16:16:37');
INSERT INTO `sys_logininfo` VALUES ('355', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-12 16:30:11');
INSERT INTO `sys_logininfo` VALUES ('356', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 09:05:44');
INSERT INTO `sys_logininfo` VALUES ('357', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 09:40:44');
INSERT INTO `sys_logininfo` VALUES ('358', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 09:53:07');
INSERT INTO `sys_logininfo` VALUES ('359', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 09:53:09');
INSERT INTO `sys_logininfo` VALUES ('360', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 10:13:29');
INSERT INTO `sys_logininfo` VALUES ('361', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 11:18:04');
INSERT INTO `sys_logininfo` VALUES ('362', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 11:21:33');
INSERT INTO `sys_logininfo` VALUES ('363', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 14:07:06');
INSERT INTO `sys_logininfo` VALUES ('364', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 14:14:35');
INSERT INTO `sys_logininfo` VALUES ('365', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 14:46:37');
INSERT INTO `sys_logininfo` VALUES ('366', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 14:50:06');
INSERT INTO `sys_logininfo` VALUES ('367', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 15:25:06');
INSERT INTO `sys_logininfo` VALUES ('368', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 15:33:00');
INSERT INTO `sys_logininfo` VALUES ('369', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 16:26:18');
INSERT INTO `sys_logininfo` VALUES ('370', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 16:39:29');
INSERT INTO `sys_logininfo` VALUES ('371', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 16:41:34');
INSERT INTO `sys_logininfo` VALUES ('372', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 16:49:35');
INSERT INTO `sys_logininfo` VALUES ('373', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 20:39:18');
INSERT INTO `sys_logininfo` VALUES ('374', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 21:29:42');
INSERT INTO `sys_logininfo` VALUES ('375', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 21:30:07');
INSERT INTO `sys_logininfo` VALUES ('376', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-13 22:18:28');
INSERT INTO `sys_logininfo` VALUES ('377', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-14 01:10:02');
INSERT INTO `sys_logininfo` VALUES ('378', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-14 17:07:24');
INSERT INTO `sys_logininfo` VALUES ('379', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-14 22:04:13');
INSERT INTO `sys_logininfo` VALUES ('380', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 09:48:20');
INSERT INTO `sys_logininfo` VALUES ('381', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 09:50:11');
INSERT INTO `sys_logininfo` VALUES ('382', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 10:22:23');
INSERT INTO `sys_logininfo` VALUES ('383', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 10:31:33');
INSERT INTO `sys_logininfo` VALUES ('384', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 10:37:28');
INSERT INTO `sys_logininfo` VALUES ('385', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 11:29:44');
INSERT INTO `sys_logininfo` VALUES ('386', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 11:35:15');
INSERT INTO `sys_logininfo` VALUES ('387', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 11:38:20');
INSERT INTO `sys_logininfo` VALUES ('388', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 14:25:08');
INSERT INTO `sys_logininfo` VALUES ('389', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 14:37:34');
INSERT INTO `sys_logininfo` VALUES ('390', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 14:51:36');
INSERT INTO `sys_logininfo` VALUES ('391', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 14:57:55');
INSERT INTO `sys_logininfo` VALUES ('392', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 15:00:23');
INSERT INTO `sys_logininfo` VALUES ('393', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 15:37:38');
INSERT INTO `sys_logininfo` VALUES ('394', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 15:39:01');
INSERT INTO `sys_logininfo` VALUES ('395', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 15:40:34');
INSERT INTO `sys_logininfo` VALUES ('396', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 16:44:20');
INSERT INTO `sys_logininfo` VALUES ('397', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 19:25:20');
INSERT INTO `sys_logininfo` VALUES ('398', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 20:52:02');
INSERT INTO `sys_logininfo` VALUES ('399', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-15 23:16:39');
INSERT INTO `sys_logininfo` VALUES ('400', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 09:35:17');
INSERT INTO `sys_logininfo` VALUES ('401', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 09:50:35');
INSERT INTO `sys_logininfo` VALUES ('402', 'admin', '192.168.9.203', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 10:23:34');
INSERT INTO `sys_logininfo` VALUES ('403', 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 11:08:50');
INSERT INTO `sys_logininfo` VALUES ('404', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 11:18:22');
INSERT INTO `sys_logininfo` VALUES ('405', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 11:19:44');
INSERT INTO `sys_logininfo` VALUES ('406', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 11:32:56');
INSERT INTO `sys_logininfo` VALUES ('407', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 11:34:01');
INSERT INTO `sys_logininfo` VALUES ('408', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 14:45:08');
INSERT INTO `sys_logininfo` VALUES ('409', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 14:45:21');
INSERT INTO `sys_logininfo` VALUES ('410', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 14:45:41');
INSERT INTO `sys_logininfo` VALUES ('411', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 14:55:03');
INSERT INTO `sys_logininfo` VALUES ('412', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 14:55:19');
INSERT INTO `sys_logininfo` VALUES ('413', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 15:52:48');
INSERT INTO `sys_logininfo` VALUES ('414', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 15:54:08');
INSERT INTO `sys_logininfo` VALUES ('415', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 16:12:03');
INSERT INTO `sys_logininfo` VALUES ('416', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 16:47:22');
INSERT INTO `sys_logininfo` VALUES ('417', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 20:10:14');
INSERT INTO `sys_logininfo` VALUES ('418', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-16 20:10:28');
INSERT INTO `sys_logininfo` VALUES ('419', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-17 00:45:45');
INSERT INTO `sys_logininfo` VALUES ('420', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-17 01:00:57');
INSERT INTO `sys_logininfo` VALUES ('421', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-17 01:04:55');
INSERT INTO `sys_logininfo` VALUES ('422', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-22 18:30:37');
INSERT INTO `sys_logininfo` VALUES ('423', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 09:56:25');
INSERT INTO `sys_logininfo` VALUES ('424', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 10:15:56');
INSERT INTO `sys_logininfo` VALUES ('425', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 10:33:49');
INSERT INTO `sys_logininfo` VALUES ('426', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 10:36:48');
INSERT INTO `sys_logininfo` VALUES ('427', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 10:46:17');
INSERT INTO `sys_logininfo` VALUES ('428', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 10:49:14');
INSERT INTO `sys_logininfo` VALUES ('429', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 11:00:12');
INSERT INTO `sys_logininfo` VALUES ('430', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 11:05:47');
INSERT INTO `sys_logininfo` VALUES ('431', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 11:08:47');
INSERT INTO `sys_logininfo` VALUES ('432', 'admin', '127.0.0.1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 11:09:55');
INSERT INTO `sys_logininfo` VALUES ('433', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 11:13:08');
INSERT INTO `sys_logininfo` VALUES ('434', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 11:54:41');
INSERT INTO `sys_logininfo` VALUES ('435', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 14:20:19');
INSERT INTO `sys_logininfo` VALUES ('436', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 14:31:48');
INSERT INTO `sys_logininfo` VALUES ('437', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 14:37:10');
INSERT INTO `sys_logininfo` VALUES ('438', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 14:45:41');
INSERT INTO `sys_logininfo` VALUES ('439', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 14:49:36');
INSERT INTO `sys_logininfo` VALUES ('440', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 16:21:34');
INSERT INTO `sys_logininfo` VALUES ('441', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 17:58:11');
INSERT INTO `sys_logininfo` VALUES ('442', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 18:07:11');
INSERT INTO `sys_logininfo` VALUES ('443', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 18:11:17');
INSERT INTO `sys_logininfo` VALUES ('444', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 18:11:21');
INSERT INTO `sys_logininfo` VALUES ('445', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 18:12:20');
INSERT INTO `sys_logininfo` VALUES ('446', 'yl', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-24 18:13:48');
INSERT INTO `sys_logininfo` VALUES ('447', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-25 22:45:51');
INSERT INTO `sys_logininfo` VALUES ('448', 'admin', '0:0:0:0:0:0:0:1', '内网IP', 'Chrome 9', 'Windows 10', '0', '登录成功', '2021-12-25 22:59:41');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1126 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
...
INSERT INTO `sys_post` VALUES ('4', 'user', '普通员工', '4', '1', '普通员工');
...
CREATE TABLE `sys_role` (
  ...
  `remark` varchar(500) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='角色信息表';
...
INSERT INTO `sys_role` VALUES ('5', '店长', 'shopOwner', '4', null, '0', '0', '2021-09-11 11:49:55', '');
INSERT INTO `sys_role` VALUES ('6', '财务专员', 'financial', '5', '1', '0', '0', '2021-09-11 11:49:57', '');
INSERT INTO `sys_role` VALUES ('7', '总经理', 'generalManager', '6', null, '0', '0', '2021-09-11 11:50:00', '');
...
INSERT INTO `sys_user` VALUES ('9', '103', 'lin', '林叫兽', '00', '123@qq.com', '15315315332', '0', '', '1a9afbc60137abc3ed4ee54dd16bdabc', 'f28344', '0', '0', '', null, '');
