...
public class PullDownListViewAdapterDailyList extends BaseAdapter {
    ...
    public PullDownListViewAdapterDailyList(String doMain, Context context, DailyModel dailyModel, int layoutResource) {
    ...
    // 获取列表项视图
    public View getView(final int position, View view, ViewGroup arg) {
